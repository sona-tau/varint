...
/*! This is an unsigned varint; a more restricted version of LEB128.
 * See: https://github.com/multiformats/unsigned-varint. */
typedef uint8_t *varint;

/*! This is the result of dividing by 10, q is owned by the caller.
 */
typedef struct {
  varint q;  /*!< You must free this! */
  uint8_t r; /*!< The remainder of dividing by 10. */
} divmod10;
